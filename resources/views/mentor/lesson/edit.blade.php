        ...
        <div class="form-row">
            ...
            <div class="col-md-12 mb-3">
                ...
                <select name="chapter_id" class="form-select" >
                    ...
                    <option value="{{$c->id}}" {{ $c->id == $lesson->chapter_id ? 'selected' : '' }}>{{$c->name}} - {{$c->course->title}}</option>
                    @endforeach
                </select>
            </div>
            ...
            <div class="col-md-12 mb-3">
             ...
             <div class="col-md-12 mb-3">
                <label for="validationServer01">Time</label>
                <input type="text" class="form-control" id="validationServer01" placeholder="masukkan Durasi" name="time" value="{{ $lesson->time }}" >
            </div>
