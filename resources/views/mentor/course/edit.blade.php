...
@section('content')
    ...
    <form action="{{ route('mentor.update.course', $course->id) }}" method="POST" enctype="multipart/form-data" >
        ...
        <div class="form-row">
            ...
            <div class="col-md-12 mb-3">
                <label for="validationServer01">About</label>
                <input type="text" class="form-control" id="validationServer01" placeholder="Masukan About Course" name="about" value="{{$course->about}}" >
                <div class="valid-feedback">
                    Looks good!
                </div>
            </div>
            ...
            <div class="col-md-3 mt-3">
               ...
               {{-- <div class="col-md-3 mb-3">
                <label for="validationServer02">Materi</label>
                <input type="file" class="form-control" id="validationServer02" placeholder="" name="materi"  value="" r > 
            </div>
            ...
            <div class="col-md-12 mt-2 mb-3">
                <textarea id="mytextarea" cols="243" rows="25" name="description">{{$course->description}}</textarea>
            </div>
