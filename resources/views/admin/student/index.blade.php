...
@section('content')
    ...
    @endif
        ...
        <div class="btn-user-admin mb-3">
            <a href="{{ route('student.create')  }}" class="btn btn-primary"><i class="fa fa-plus"> Add Student</i></a>   
        </div>
        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <td> 
                    <form action="{{ route('student.destroy',$c->id) }}" method="POST">
                    <a href="{{route('student.show', $c->id)}}" class="btn btn-primary btn-md"><i class="fa fa-eye"></i></a> |
                    <a href="{{route('student.edit', $c->id)}}" class="btn btn-warning"><i class="fa fa-edit"></i></a> |
