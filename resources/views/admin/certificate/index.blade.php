    ...
    @endif
        ...
        <table id="table_id" class="table table-striped table-bordered" style="width:100%">
            ...
            <tbody>
                ...
                <td>
                      @if($item->status == 'success')
                     <a href="{{route('admin.certificate.status', $item->id)}}" class="btn btn-danger">Batalkan Verifikasi</a>
                     @else
                     <a href="{{route('admin.certificate.status', $item->id)}}" class="btn btn-success">Verifikasi</a>
